...
class Content3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val upload3: Button = findViewById(R.id.upload3)
        ...
        val nextBtn: Button = findViewById(R.id.next3)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        val imageView: ImageView = findViewById(R.id.imageupload3)
    ...
    private fun uploadFile(){
        if (imageUri != null) {
            ...
            val imageRef = FirebaseStorage.getInstance().reference.child("user:$user/" + "proof_of_crime")
            ...
            imageRef.putFile(imageUri)
                .addOnSuccessListener {
                    ...
                    finish()
                    intent = Intent(this, Content4::class.java)
                    startActivity(intent)
